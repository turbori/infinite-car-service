      ...
      <section className="py-24 bg-[#050505]">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <div className="my-16 p-8 bg-white/5 rounded-2xl border-l-4 border-blue-500">
              <h3 className="text-2xl font-bold text-white mb-4 m-0">The Infinite Standard</h3>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center">Why We Are Different</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 not-prose">
              <div className="p-6 bg-white/5 rounded-xl">
                <h4 className="text-xl font-bold text-white mb-2">Immaculate Vehicles</h4>
                <p className="text-gray-400 text-sm">Our fleet is detailed daily. We strictly prohibit smoking and maintain a showroom-level of cleanliness for every passenger.</p>
              </div>
              <div className="p-6 bg-white/5 rounded-xl">
                <h4 className="text-xl font-bold text-white mb-2">Vetted Chauffeurs</h4>
                <p className="text-gray-400 text-sm">Our drivers are professionals, not gig workers. They undergo background checks, drug testing, and rigorous training.</p>
              </div>
              <div className="p-6 bg-white/5 rounded-xl">
                <h4 className="text-xl font-bold text-white mb-2">24/7 Dispatch</h4>
                <p className="text-gray-400 text-sm">Flight delayed at 2 AM? We are watching. Our dispatch team is available around the clock to adjust your reservation.</p>
              </div>
              <div className="p-6 bg-white/5 rounded-xl">
                <h4 className="text-xl font-bold text-white mb-2">Transparent Pricing</h4>
                <p className="text-gray-400 text-sm">No hidden fees or surge pricing. The price we quote is the price you pay, with all tolls and gratuity clearly outlined.</p>
              </div>
            </div>
          </motion.div>
        </div>
